...
where id in(
 select company_id from transaction where declined=0 and amount >(select avg(amount) from transaction where declined=0 ) );
...
date(tran.timestamp)='2024-03-13') and declined =0
